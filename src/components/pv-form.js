      ...
      <div className="container-fluid">
        <div className="pv-form data-form row">
            ...
            >
              <div className="form-group">
                <label htmlFor="latitude">
                  Latitude<sup className="text-orange">*</sup>
                </label>
                <input
              ...
              <div className="form-group">
                <label htmlFor="longitude">
                  Longitude<sup className="text-orange">*</sup>
                </label>
                <input
                  className="form-control"
                  id="longitude"
              ...
              <div className="form-group">
                <label htmlFor="capacity">
                  Capacity (Watts)<sup className="text-orange">*</sup>
                </label>
                <input
                  type="number"
                  className="form-control"
          ...
          <div className="col-8 pt-5">
            ...
            {this.props.error && (
              <p className="text-orange text-center">{this.props.error}</p>
            )}
          </div>
        </div>
      </div>
